...
goals_against as (
    ...
    select 
        ...
        sum(case when event_type in ('shot-on-goal', 'goal') then 1 else 0 end) as shots_on_goal_against,
...
select 
    ...
    ifnull(shots_on_goal_against, 0)::int as shots_on_goal_against,
    ...
    round((shots_on_goal_against - goals_against) / shots_on_goal_against * 100, 1) as save_pct,
